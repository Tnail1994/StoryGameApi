...
public class StoryService {
    ...
    public StoryService() {
        ...
        aRandomStory.addSentence("Bob suddenly realized he had forgotten to put on pants before leaving the house.");
        aRandomStory.addSentence("As he rushed back inside, he tripped over his dog and landed face-first in a mud puddle.");
        aRandomStory.addSentence("The entire neighborhood erupted in laughter, forever cementing Bob's reputation as the town's most absent-minded resident.");
        aRandomStory.addSentence("Bob's wife watched the whole debacle unfold from the front window, shaking her head in exasperation.");
        aRandomStory.addSentence("Later that evening, Bob swore he'd never leave the house without doing a full clothes check again.");
